...
const blogs = [
  ...
  },
  {
    ...
    text: "Community wellness initiatives play an important role in promoting healthier and more active lifestyles.",
  },
  {
  ...
  },
  {
    ...
    text: "Discipline and mental strength are essential qualities for personal development and long-term success.",
  },
];
      ...
      <div className="row">
        ...
        <div className="col-xl-6 align-self-center">
          <div className="blog_content">
            ...
            <p>{blog.text}</p>
            <a href={`/blog/${blog.slug}`} className="blog_btn">
